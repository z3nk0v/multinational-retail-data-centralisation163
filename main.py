...
def upload_dim_card_details():
    ...
    #df = de.retrieve_pdf_data('https://data-handling-public.s3.eu-west-1.amazonaws.com/card_details.pdf')- this didnt work for some reason so had to use a local csv file
...
def dim_date_times():
    ...
    #calls our function to extract from s3
